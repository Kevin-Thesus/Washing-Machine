   ...
   power_on_screen();
    ...
    if(key == 0XB7 && operation_mode == 0x01)
    {
    ...
    else if(key == 0XB7 && operation_mode == 0x02)
        {
            ...
            operation_mode = 0x03;
            clear_screen();
            clcd_print("Press Switch",(0x80 + 1));
            clcd_print("SW5: START",(0xC0 + 1));
            clcd_print("SW6: STOP",(0x90 + 1));

        }

        if(key == 0x2F && operation_mode == 0x05)
        {
            TMR2ON = 1;
            RC2 = 1;
            operation_mode = 0x04;
 ...
 void washing_program_display(unsigned char key)
{
     ...
     if(program_no <= 9)
     {
     clcd_print(washing_program[program_no],(0xC0 + 2));
     clcd_print(washing_program[program_no + 1],(0x90 + 2));
     clcd_print(washing_program[program_no + 2],(0xD0 + 2));
     }
     ...
     clcd_print(washing_program[program_no],(0xC0 + 2));
     clcd_print(washing_program[program_no + 1],(0x90 + 2));
     clcd_print(washing_program[0],(0xD0 + 2));
     }

     else if (program_no == 11)
     {
     clcd_print(washing_program[program_no],(0xC0 + 2));
     clcd_print(washing_program[0],(0x90 + 2));
     clcd_print(washing_program[1],(0xD0 + 2));
     }
 ...
 void water_level_display(unsigned char key)
 {
     ...
     {
         clcd_print(water_level_options[water_level_index],(0xC0 + 2));
         clcd_print(water_level_options[water_level_index + 1],(0x90 + 2));
         clcd_print(water_level_options[water_level_index + 2],(0xD0 + 2));
     ...
     else if (water_level_index == 3)
     {
         clcd_print(water_level_options[water_level_index],(0xC0 + 2));
         clcd_print(water_level_options[water_level_index + 1],(0x90 + 2));
         clcd_print(water_level_options[0],(0xD0 + 2));

     }
     else if (water_level_index == 4)
     {
         clcd_print(water_level_options[water_level_index],(0xC0 + 2));
         clcd_print(water_level_options[0],(0x90 + 2));
         clcd_print(water_level_options[1],(0xD0 + 2));
 ...
 void set_time(void)
 {
     ...
     void run_program(unsigned char key)
     {
         ...
         if(reset_mode == 0x12)
         {
             ...
             clcd_print("TIME: ",(0xC0 + 0));
             clcd_print("5-START  6-PAUSE ",(0xD0 + 0));
         ...
         else if(program_no == 0)
         {
             if(total_time >= time - (0.40 *time))
             {
                 clcd_print("Rinse",(0x80 + 11));
